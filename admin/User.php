...
<head>
    ...
    <meta name="author" content="Rasul Pundogar">
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="sidebar border border-right col-md-3 col-lg-2 p-0 bg-body-tertiary">
                <div class="offcanvas-md offcanvas-end bg-body-tertiary" tabindex="-1" id="sidebarMenu"
                    ...
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="sidebarMenuLabel">BluePhenix</h5> <button type="button"
                        ...
                        <ul class="nav flex-column">
                            <li class="nav-item"> 
                                <a class="nav-link d-flex align-items-center gap-2 active"
                                    aria-current="page" href="/webdev_sample_project/admin/dashboard.php"> <svg class="bi" aria-hidden="true">
                                        <use xlink:href="#house-fill"></use>
                                    </svg>
                                    Dashboard
                                </a> </li>
                            <li class="nav-item"> 
                                <a class="nav-link d-flex align-items-center gap-2" href="/webdev_sample_project/admin/User.php"> <svg
            ...
            <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="row">
                    <div class="col-lg-12">
                         <form method="POST" onsubmit="registerUser(event)" id="registerForm">
                            <div class="mb-3">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <tbody id="userList">
                            <!-- Add the id=userList to call this in the javascript and populate it -->
                        </tbody>
                        </table>
                    </div>
                </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form method="POST" onsubmit="updateUser(event)" id="editUserForm">
                                    <input type="hidden" id="editUserId">
                                    <div class="mb-3">
                                        <label for="editUsername" class="form-label">Username</label>
                                        <input type="text" class="form-control" id="editUsername" aria-describedby="editEmailHelp">
                                        <div id="editEmailHelp" class="form-text">We'll never share your username with anyone else.</div>
                                    </div>
                                    <div class="mb-3">
        ...
        function registerUser(event) {
            ...
            .then(data => {
                if (data.status == 'success') {
                    ...
                    document.getElementById('registerForm').reset(); // this is to reset the form
                }
            })
            .catch(error => {
                    ...
                    if (data.status == 'success') {
                        ...
                        users.forEach(user => {
                            userList += `<tr>
                                ...
                                <td>${user.role}</td>
                                <td>
                                    <button class="btn btn-sm btn-outline-primary" onclick="openEditModal('${user.id}', '${user.username}', '${user.password}', '${user.role}')">Edit</button>
                                    <button class="btn btn-sm btn-outline-danger" onclick="openDeleteModal('${user.id}')">Delete</button>
                                </td>
                            </tr>`;
                        });
